...
export function ComicReader({
  ...
  return (
    ...
    <div className="fixed inset-0 flex flex-col bg-black">
      {/* Top bar */}
      {!immersive && (
      <header className="animate-lib-fade-in sticky top-0 z-40 flex h-12 items-center justify-between border-b border-white/10 bg-black/90 px-3 backdrop-blur pt-[var(--app-safe-top)]" style={{ height: "calc(3rem + var(--app-safe-top))" }}>
